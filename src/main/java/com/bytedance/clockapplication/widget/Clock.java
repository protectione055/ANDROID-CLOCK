...
public class Clock extends View {
    ...
    protected void onDraw(final Canvas canvas){
        ...
        HOUR_POINTER_LENGTH = PANEL_RADIUS - 325;
        MINUTE_POINTER_LENGTH = PANEL_RADIUS - 225;
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        int timeZone = 8;
        int nowHours = calendar.get(Calendar.HOUR_OF_DAY) + timeZone;
    ...
    private void drawPointer(Canvas canvas, int pointerType, int value) {
        ...
        switch (pointerType) {
            case 0:
                mNeedlePaint.setStrokeWidth(mWidth * DEFAULT_DEGREE_STROKE_WIDTH * 1.5f);
